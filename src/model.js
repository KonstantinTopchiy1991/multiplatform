...
export default class Model {
    ...
    constructor () {
        this.containerBodyPaint = '<div class="container-body__paint" id="containerBodyPaint" >\n' +
            ...
            '                            <h3>Tools</h3><hr>\n' +
            '                            <ul id="tools">\n' +
            '                                <li id="means_brush"><img src="dist/img/Brush.png" alt="Кісточка" title="Pen"></li>\n' +
            '                                <li id="means_eraser"><img src="dist/img/Eraser.png" alt="" title="Eraser"></li>\n' +
            '                                <li id="means_paint"><img src="dist/img/bucket.png" alt="" title="Fill"></li>\n' +
            '                                <li class="" id="means_straw"><img src="dist/img/8.png" alt="" title="Delete All"></li>\n' +
            '                                <li class="hide" id="means_text"><img src="dist/img/text.png" alt="" title="Search"></li>\n' +
        ...
        this.containerBodyMain = '<div class="container-body__main" id="containerBodyMain">\n' +
            ...
            '                            <p class="paint-description__text">Paint allows you to draw a picture using the tools: line, square, circle and eraser</p>\n' +
            '                        </div>\n' +
            '                    </div>\n' +
        ...
        this.containerBodyLogin = '<div class="login-container">\n' +
            '                    <div class="login-container__inputs" id="loginContainerInputs" >\n' +
            ...
            '                        <div class="login-container__error-box" id="errorBox">\n' +
            '                            \n' +
            '                        </div>\n' +
            '                        \n' +
            '\n' +
        ...
        this.containerBodyCrud = ' <div class="container-body__crud" id="containerBodyCrud" >\n' +
            ...
            '                            <button class="crud-buttons__button" id=\'addStart\'>Add Start</button>\n' +
        ...
        this.containerBodyRegistrationDk = '<div class="container-body__registration-dk" id="containerBodyRegistrationDk" >\n' +
            ...
            '                                <input class="registration-input" id="pasportNameForTranslate" placeholder="Document № * (enter data in Latin)">\n' +
            '                                <p class="message_inn"></p>\n' +
            '                            </div>\n' +
            '                            <div class="registration-inputs__passportDate" id="_date_passport">\n' +
            '                                 <form action="#">\n' +
            '                                <input class="registration-input tcal" id="placeOfBirth" type="text" name="date" value="" placeholder="Passport issue date *">\n' +
            '                                <p class="message_inn"></p>\n' +
            '                                 </form>\n' +
            '                            </div>\n' +
            ...
            '                            <div class="registration-info-dk__stability" id="bankSecurity">\n' +
            ...
            '                                </div>\n' +
            '                            </div>\n' +
            '                            <div class="registration-info-dk__stability" id="bankSavings">\n' +
            ...
            '                                </div>\n' +
            '                            </div>\n' +
            '                            <div class="registration-info-dk__stability" id="bankStability">\n' +
            ...
            '                                </div>\n' +
            '                            </div>\n' +
            '                            <div class="registration-info-dk__stability" id="bankMobile">\n' +
            ...
            '                            <p class="registration-acceptance__text">When registering, you agree to the <a class="link" href="https://privatbankinfo.com/privat24/kak-zaregistrirovatsya-v-privat24.html" target="_blank">TERMs</a> of the Bank</p>\n' +
        ...
        this.mock = '<div class="container-mock" id="containerMock">\n' +
            '                <div class="main-headline">\n' +
            '                    <h2 class="main-headline__tittle">Mock page</h2>\n' +
            '                    <p class="info-text__text">Page is under construction. Please visit this page later.</p>\n' +
            '                </div>\n' +
            '            </div>';
        this.authorisationError = '<div class="login-container__error" id="authorisationError">\n' +
            '                            <p>Please enter valid login and password </p>\n' +
            '                        </div>';
    }
}
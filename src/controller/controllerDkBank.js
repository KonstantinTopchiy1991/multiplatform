...
export default class DKBankController {
    ...
    init() {
        ...
        const bankSecurity = document.getElementById('bankSecurity');
        const bankSavings = document.getElementById('bankSavings');
        const bankStability = document.getElementById('bankStability');
        ...
        bankSecurity.addEventListener('click', function (e) {
            controller.insertToBodyBlock(view.containerBody, model.mock);
        });

        bankSavings.addEventListener('click', function (e) {
            controller.insertToBodyBlock(view.containerBody, model.mock);
        });

        bankStability.addEventListener('click', function (e) {
            controller.insertToBodyBlock(view.containerBody, model.mock);
        });

        bankMobile.addEventListener('click', function (e) {
            controller.insertToBodyBlock(view.containerBody, model.mock);
        });

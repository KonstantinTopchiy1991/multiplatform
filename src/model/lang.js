...
function engLang () {
	...
	paintDescription.innerHTML = 'Paint allows you to draw a picture using the tools: line, square, circle and eraser';
	crudDescription.innerHTML = 'Copy, Read, Upgrade, Delete yours user information in database simply and fast';
